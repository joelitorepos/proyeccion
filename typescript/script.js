"use strict";
// -- formulario -
const formulario = document.getElementById("formulario-ventas");
// -- inputs --
...
class Fecha {
    ...
    static diasRestantes(asuetos = 0) {
...
class Proyeccion {
    static setMetaVentas(meta) {
        this.metaVentas = meta;
    }
    static setArticulosVendidos(articulos) {
        this.articulosVendidos = articulos;
    }
    static setAsuetos(numAsuetos) {
...
// -- datos iniciales --
Proyeccion.metaVentas = 0;
Proyeccion.articulosVendidos = 0;
Proyeccion.asuetos = 0;
// -- datos esperados --
Proyeccion.metaDiaria = 0;
Proyeccion.proyeccion = 0;
Proyeccion.porcentajeProyeccion = 0;
